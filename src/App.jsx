...
function App() {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
    >
      <h1 className="text-3xl font-bold mb-4 dark:text-white">Pixel Art PNG to SVG</h1>
      ...
      <div className="border-4 border-dashed border-gray-400 dark:border-gray-200 p-6 rounded-lg bg-white dark:bg-slate-600 max-w-xl mx-auto mb-4">
        <p className="mb-2 dark:text-white">Drag and drop a PNG file here or use the button:</p>
        <label
          htmlFor="file-upload"
...

      {
        isLoading && (
          <div className="mt-4 flex justify-center">
            <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 dark:fill-cyan-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
